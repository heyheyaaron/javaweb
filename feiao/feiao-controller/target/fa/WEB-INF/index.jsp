											...
											<dd class="rt-main">
												...
												<p class="rt-href">
													<a class="rth" href="/note/showNoteContent.do?id=${hn['id']}">
														<c:if test="${fn:length(hn['title'])>15}">
																<c:set var = "string223" value = "${fn:substring(hn['title'],0, 15)}" />
																${string223}...
															</c:if>
															<c:if test="${fn:length(hn['title'])<=15}">
																${hn['title']}
												...
												<div class="rt-meta">
													<span class="readicon_uinfo_5"
														...
														class="alink" href="/note/showNoteContent.do?id=${hn['id']}">阅读全文</a></span>
												</div>
												<div class="content">
													<c:if test="${fn:length(hn['desc'])>100}">
														<c:set var = "string223" value = "${fn:substring(hn['desc'],0, 100)}" />
														${string223}...
													</c:if>
													<c:if test="${fn:length(hn['desc'])<=100}">
														${hn['desc']}
													...
													<div id="portal_block_533_content" class="dxb_bc">
														<div class="module cl xl">
															<ul>
																...
																${gujian[0].desc}
																	<!-- <dl class="cl xld">
																		<dt style="font-size:14px;color:#222222;font-weight:bold;line-height:24px;padding:2px 0px;">Flyme 6.7.3.28 beta</dt>
