...
<form id="userForm">
<input type="hidden" name="fa_id" value="${faSection.fa_id}"/>
<table class="table table-bordered ">
    ...
    <tr>
        <td width="15%" >版块名字</td>
        <td><input type="text" name="fa_name" value="${faSection.fa_name}"/></td>
    </tr>
    <tr>
           <td >描述</td>
           <td>
              <textarea  cols="30" name="fa_desc" >${faSection.fa_desc}</textarea>
           </td>
    </tr>
    
    <tr>
        <td >排序</td>
        <td><input type="number" name="fa_sort" id="sort" value="${faSection.fa_sort}" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/><font color="red">    *0~999，数值最小排序越高</font></td>
    </tr>
    ...
    $(function () {       
		...
		$("#savebtn").click(function(){
			...
			if($("#sort").val()!='' && Number($("#sort").val())>=0 && Number($("#sort").val())<=999){
				$.ajax({
					url:"${path}/bbs/sureUpdateModel.do",
					type:"post",
		...
		$.ajax({
			...
			success : function(data){
				...
				var fpg = "${faSection.fa_postr}".split(",");
				var frg = "${faSection.fa_repliesr}".split(",");
				var fzg = "${faSection.fa_zanr}".split(",");
				var fvg = "${faSection.fa_voter}".split(",");
				var fag = "${faSection.fa_readr}".split(",");
				for(i in data){
					var x =0;
					for(j in fpg){
						if(fpg[j]==data[i].fa_id){
							x=1
							break;
						}
					}
					...
					if(x){
						vap=vap+'<input type="checkbox" name="fa_postr" value="'+data[i].fa_id+'"   checked="checked"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
						vap=vap+'<input type="checkbox" name="fa_postr" value="'+data[i].fa_id+'"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}
					x=0
					for(j in frg){
						if(frg[j]==data[i].fa_id){
							x=1;
							break;
						}
					}
					if(x){
						val=val+'<input type="checkbox" name="fa_repliesr" value="'+data[i].fa_id+'"  checked="checked"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
						val=val+'<input type="checkbox" name="fa_repliesr" value="'+data[i].fa_id+'"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}
					x=0
					for(j in fzg){
						if(fzg[j]==data[i].fa_id){
							x=1
							break;
						}
					}
					if(x){
						vaz=vaz+'<input type="checkbox" name="fa_zanr" value="'+data[i].fa_id+'"  checked="checked"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
						vaz=vaz+'<input type="checkbox" name="fa_zanr" value="'+data[i].fa_id+'"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}
					x=0
					for(j in fvg){
						if(fvg[j]==data[i].fa_id){
							x=1
							break;
						}
					}
					if(x){
						vae=vae+'<input type="checkbox" name="fa_voter" value="'+data[i].fa_id+'"  checked="checked"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
						vae=vae+'<input type="checkbox" name="fa_voter" value="'+data[i].fa_id+'"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}
					x=0
					for(j in fag){
						if(fag[j]==data[i].fa_id){
							x=1
							break;
						}
					}
					if(x){
						vaa=vaa+'<input type="checkbox" name="fa_readr" value="'+data[i].fa_id+'"  checked="checked"> '+data[i].fa_name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
		...
		$.ajax({
			...
			success : function(data){
				...
				var fpg = "${faSection.fa_postg}".split(",");
				var frg = "${faSection.fa_repliesg}".split(",");
				var fzg = "${faSection.fa_zang}".split(",");
				var fvg = "${faSection.fa_voteg}".split(",");
				var fag = "${faSection.fa_readg}".split(",");
				for(i in data){
					var x = 0;
					for(j in fpg){
						if(fpg[j]==data[i].id){
					...
					if(x){
						vap=vap+'<input type="checkbox" name="fa_postg" value="'+data[i].id+'"  checked="checked"> '+data[i].name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
					...
					if(x){
						val=val+'<input type="checkbox" name="fa_repliesg" value="'+data[i].id+'"  checked="checked"> '+data[i].name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
					...
					if(x){
						vaz=vaz+'<input type="checkbox" name="fa_zang" value="'+data[i].id+'"  checked="checked"> '+data[i].name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
					...
					if(x){
						vae=vae+'<input type="checkbox" name="fa_voteg" value="'+data[i].id+'"  checked="checked"> '+data[i].name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
					...
					if(x){
						vaa=vaa+'<input type="checkbox" name="fa_readg" value="'+data[i].id+'"  checked="checked"> '+data[i].name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
					}else{
