...
<form id="saveForm">
	<input type="hidden" name="fa_pid" value="${sid}" />
    <table class="table table-bordered ">
        <tr>
            <td width="10%" >版块分类名字</td>
...
<script>
    ...
    $(function () {
    	$('#backid').click(function(){
			window.location.href="${path}/bbs/returnModelType.do?id=${sid}";
	 	});
				...
				success:function(data){
					if(data.tip=="success"){
						sweetAlert({
				 			...
				 			window.location.href="${path}/bbs/returnModelType.do?curpage=${curpage}&id=${sid}";
				 		});
				}else{
					sweetAlert({
			 			title: "",
