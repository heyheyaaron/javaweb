...
<form id="saveForm">
    ...
    <table class="table table-bordered ">
        ...
        <tr>
            <td width="10%" >角色代码</td>
            <td><input type="text" name="code" value="${role.code}"/></td>
        </tr>
        <tr>
            <td >角色描述</td>
            <td>
               <textarea  cols="30" name="remark">${role.remark}</textarea>
            </td>
        </tr>
        <tr>
            <td >权限</td>
		...
		for(var j=0;j<data.length;j++){
			 if(id==data[j].pid){
				 ...
				 if(istrues){
					 ...
					 var vas="<ul><li><label class='checkbox inline'><input type='checkbox' name='group' value='"+data[j].id+"' checked='checked' />"+data[j].name+"</label>";
    ...
    $(function () {
    	...
    	$('#backid').click(function(){
		 ...
		 $("#savebtn").click(function(){
			 ...
			 $.ajax({
				url:"${path}/system/sureUpdateRole.do",
