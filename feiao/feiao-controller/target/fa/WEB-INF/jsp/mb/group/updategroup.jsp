...
<form id="userForm">
<input type="hidden" name="fa_id" value="${faGroups.fa_id}"/>
<table class="table table-bordered ">
    
    
    <tr>
        <td width="10%" >勋章名字</td>
        <td><input type="text" name="fa_name" value="${faGroups.fa_name}"/></td>
    </tr>
    <tr>
           <td >描述</td>
           <td>
              <textarea  cols="30" name="fa_desc" >${faGroups.fa_desc}</textarea>
           </td>
    </tr>
    ...
    <tr>
        <td >图片</td>
        <td>
        	<img src="${faGroups.fa_image}" id="pic_target" width="70px" height="70px">
        	<br>
			...
			<input  type="text" id="pic_hidden" name="fa_image" style="display: none;" value="${faGroups.fa_image}"/>
        </td>
    </tr>
    ...
    <tr>
        <td ></td>
        <td>
        <shiro:hasPermission name="mbgroup:update">
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${path}/member/returnGroup.do?curpage=${curpage}";
		 });
		$("#savebtn").click(function(){
			
			
				$.ajax({
					url:"${path}/member/sureUpdateGroup.do",
					type:"post",
