...
<form id="userForm" name="userForm" method="post"  onsubmit="return sb1();">
				<input type="hidden" name="fa_pid" value="${id}" > 
				<div align="left">
					<table class="table table-bordered ">
						...
						<tr  >
							<td width="10%" >名称：</td>
							<td >
								<input type="text" name="fa_name" id="fa_name" >
							</td>
						</tr>
						<tr  >
							<td  >链接：</td>
							<td >
								<input type="text" name="fa_url" id="fa_url" >
							</td>
						</tr>
						<tr>
					        <td >图片</td>
						...
						<tr>
					        <td >排序</td>
					        <td><input type="number" name="fa_sort" id="sort" value="0"  onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/><font color="red">    *0~999，数值最小排序越高</font></td>
					    </tr>
