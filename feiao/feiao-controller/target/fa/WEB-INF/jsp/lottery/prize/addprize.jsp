...
<table class="table table-bordered ">
    ...
    <tr>
        ...
        <td>
			...
			<input  type="text" id="pic_hidden" name="fa_img" style="display: none;"/>
        </td>
    </tr>
    <tr>
           <td >奖品类型</td>
           <td>
              <input type="radio" name="fa_type" value="0" checked="checked" />飞镖 &nbsp;&nbsp;&nbsp;<input type="radio" name="fa_type" value="1"/>物品
           </td>
    </tr>
    <tr>
        <td >数量</td>
        <td><input type="text" name="fa_num" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" /></td>
    </tr>
    <tr>
        <td >概率</td>
        <td><input type="text" name="fa_percent" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" />   <font color="red"> *概率为1~999999之间的整数（所有奖品的概率之和不需要等于100，后台会根据实际数据自动生成符合的概率），单位为%</font></td>
    </tr>
    <tr>
        <td >排序</td>
        <td><input type="text" name="fa_sort" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" />  <font color="red"> *0~999，数值越小排序越高</font></td>
    </tr>
...
<script>
    $(function () {       
		...
		$("#savebtn").click(function(){
				...
				$.ajax({
					url:"${path}/lottery/sureAddPrize.do",
					type:"post",
