	...
	for(var i=0; i<menu.length; i++){   
		...
		try{
			if(item.isHeader == "1"){
				...
				if(item.childMenus == ""){
					str = "<li ><a href='javascript:void(0)'><span>"+item.name+"</span></a></li>";
					$(parent).append(str);
				}else{
					str = "<li ><a href='javascript:void(0)'><span ><font size='3' class='owenlchc' >"+item.name+"</font></span><i class='icon-font icon-right'>&#xe60b;</i></a>";
