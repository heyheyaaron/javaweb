...
<table class="table table-bordered ">
    ...
    <tr>
        <td >url</td>
        <td><input type="text" name="url" /><font color="red">    *没有链接则填none</font></td>
    </tr>
    <tr>
        <td >排序</td>
    ...
    <tr>
        <td >菜单/功能</td>
        <td><input type="radio" name="isbutton" value="0" checked="checked"/>菜单             <input type="radio" name="isbutton" value="1"/>功能           </td>
    </tr>
    ...
    $(function () {       
		...
		$("#savebtn").click(function(){
			if(Number($("#sort").val())>=0 && Number($("#sort").val())<=999){
				$.ajax({
					url:"${path}/system/sureAddResource.do",
					type:"post",
