...
<table class="table table-bordered ">
    ...
    <tr>
        <td >获取条件</td>
        <td><input type="radio" name="fa_condition" checked="checked" value="0"/>手动发放    <input type="radio" name="fa_condition"  value="1"/>注册任意产品   </td>
    </tr>
    <tr>
        <td >图片</td>
        <td>
        	<img src="" id="pic_target"  style="display: none;">
        	<br>
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${path}/member/returnHonor.do";
		 });
		$("#savebtn").click(function(){
			
				$.ajax({
					url:"${path}/member/sureAddHonor.do",
					type:"post",
