...
<table class="table table-bordered ">
    <tr>
        <td width="10%" >产品代号</td>
        <td><input type="text" name="fa_id"/></td>
    </tr>
    <tr>
        <td >产品名称</td>
        <td><input type="text" name="fa_title"/></td>
    </tr>
    <tr>
        <td >产品型号</td>
        <td><input type="text" name="fa_type"/></td>
    </tr>
    <tr>
        <td >条形码</td>
        <td><input type="text" name="fa_ma"/></td>
    </tr>
    
    <tr>
        <td >产品图片</td>
        <td>
        	<img src="" id="pic_target" width="70px"  style="display: none;">
        	<br>
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${path}/pro/returnPro.do";
		 });
		$("#savebtn").click(function(){
			
				$.ajax({
					url:"${path}/pro/sureAddPro.do",
					type:"post",
