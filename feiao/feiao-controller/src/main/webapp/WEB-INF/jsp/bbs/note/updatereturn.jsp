...
<table class="table table-bordered ">
    ...
    <tr>
        <td >产品型号</td>
        <td>${faNote.fa_protype}</td>
    </tr>
    <tr>
        <td >软件版本</td>
        <td>${faNote.fa_proversion}</td>
    </tr>
    <tr>
        <td >帖子标题</td>
    ...
    <tr>
    	<td>处理进度</td>
    	<td>
    		<input type="radio" name="fa_prodel" value="0"  <c:if test="${faNote.fa_prodel==0}">checked="checked"</c:if> />  待处理&nbsp;&nbsp;<input type="radio" name="fa_prodel" value="1"  <c:if test="${faNote.fa_prodel==1}">checked="checked"</c:if> />  处理中&nbsp;&nbsp;
    		<input type="radio" name="fa_prodel" value="2"  <c:if test="${faNote.fa_prodel==2}">checked="checked"</c:if> />  已处理&nbsp;&nbsp;
    	</td>
    </tr>
